...
from sofagent.llms import BaseLLM, AnyAzureLLM
from sofagent.tools import TOOL_MAP, Tool
from sofagent.utils import run_once, format_history, read_prompts

if TYPE_CHECKING:
    from sofagent.systems import System
...
class Agent(ABC):
    ...
    def __init__(self, prompts: dict = dict(), prompt_config: Optional[str] = None, web_demo: bool = False,
                 system: Optional['System'] = None, dataset: Optional[str] = None, *args, **kwargs) -> None:
